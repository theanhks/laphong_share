...
// ignore ip list
$counter_ignore_ips = array('127.0.0.1', '127.0.0.1');


// datebase settings
$counter_host = "localhost:3307";
$counter_user = "vuduong__root";
$counter_password = "28091989";
$counter_database = "vuduong_vn_db";
