<?php /* Smarty version 2.6.19, created on 2020-08-05 08:28:33
         compiled from admin/manageaddcategory.temp.html */ ?>
...
" />
						...
						<p style ="display: none;">
							<label for="vn_sapo"><?php echo $this->_tpl_vars['amessages']['vn_description']; ?>
 *</label>
							<textarea name="vn_sapo" id="vn_sapo" rows="5" cols="5" class="mceSimple"><?php echo $this->_tpl_vars['vn_sapo']; ?>
</textarea>
						</p>
						<p style ="display: none;">
							<label for="en_sapo"><?php echo $this->_tpl_vars['amessages']['en_description']; ?>
 *</label>
							<textarea name="en_sapo" id="en_sapo" rows="5" cols="5" class="mceSimple"><?php echo $this->_tpl_vars['en_sapo']; ?>
</textarea>
						</p>
						<p>
							<label for="vn_details"><?php echo $this->_tpl_vars['amessages']['vn_details']; ?>
 *</label>
							<textarea name="vn_details" id="vn_details" rows="30" cols="5" class="mceAdvanced"><?php echo $this->_tpl_vars['vn_details']; ?>
</textarea>
						</p>
						<p>
							<label for="en_details"><?php echo $this->_tpl_vars['amessages']['en_details']; ?>
 *</label>
							<textarea name="en_details" id="en_details" rows="30" cols="5" class="mceAdvanced"><?php echo $this->_tpl_vars['en_details']; ?>
</textarea>
						</p>
						<p class="hidden">
						...
						<input name="home" id="home"  value="1" type="checkbox" style="width:50px;" /> </p>-->
						<p>
