<?php /* Smarty version 2.6.19, created on 2020-08-02 17:12:00
         compiled from admin/adminadduser.temp.html */ ?>
...
</a> &raquo; <?php echo $this->_tpl_vars['amessages']['add_user']; ?>
</h2>
            <ul id="tablist">
                <li class="current"><a href="<?php echo $this->_tpl_vars['script']; ?>
?op=admin&amp;part=user&amp;act=add&amp;pId=<?php echo $this->_tpl_vars['pId']; ?>
" title="<?php echo $this->_tpl_vars['amessages']['add_user']; ?>
 ...
 *</label>
                            ...
                            <input type="text" name="username" value="<?php if (isset ( $this->_tpl_vars['username'] )): ?><?php echo $this->_tpl_vars['username']; ?>
<?php endif; ?>" />
                        </p>
                        <p>
...
*</label>
                            ...
                            <input type="password" name="pass" value="<?php if (isset ( $this->_tpl_vars['pass'] )): ?><?php echo $this->_tpl_vars['pass']; ?>
<?php endif; ?>" />
                        </p>
                        <p>
...
*</label>
                            ...
                            <input type="password" name="confirm" value="<?php if (isset ( $this->_tpl_vars['confirm'] )): ?><?php echo $this->_tpl_vars['confirm']; ?>
<?php endif; ?>" />
                        </p>
                        <p>
...
*</label>
                            ...
                            <input type="text" name="fname" value="<?php if (isset ( $this->_tpl_vars['fname'] )): ?><?php echo $this->_tpl_vars['fname']; ?>
<?php endif; ?>" />
                        </p>
                        <p>
...
*</label>
                            ...
                            <input type="text" name="lname" value="<?php if (isset ( $this->_tpl_vars['lname'] )): ?><?php echo $this->_tpl_vars['lname']; ?>
<?php endif; ?>" />
                        </p>
                        <p>
                            ...
                            <input type="text" name="about" value="<?php if (isset ( $this->_tpl_vars['about'] )): ?><?php echo $this->_tpl_vars['about']; ?>
<?php endif; ?>" />
                        </p>
                        <p>
...
<?php endif; ?>" />
                        ...
                        <p>
                            ...
                            <input type="text" name="company" value="<?php if (isset ( $this->_tpl_vars['company'] )): ?><?php echo $this->_tpl_vars['company']; ?>
<?php endif; ?>" />
                        </p>
                        <p>
                            <label for="tax"><?php echo $this->_tpl_vars['amessages']['tax']; ?>
 </label>
                            <input type="text" name="tax" value="<?php if (isset ( $this->_tpl_vars['tax'] )): ?><?php echo $this->_tpl_vars['tax']; ?>
<?php endif; ?>" />
                        </p>
                        <p>
...
<?php endif; ?>" />
                        ...
                        <p>
                            ...
                            <input type="text" name="address2" value="<?php if (isset ( $this->_tpl_vars['address2'] )): ?><?php echo $this->_tpl_vars['address2']; ?>
<?php endif; ?>" />
                        </p>
                        <p>
...
<?php endif; ?>" />
                        ...
                        <p>
                            ...
                            <input type="text" name="fax" value="<?php if (isset ( $this->_tpl_vars['fax'] )): ?><?php echo $this->_tpl_vars['fax']; ?>
<?php endif; ?>" />
                        </p>
                        <p>
                            ...
                            <input type="text" name="cell" value="<?php if (isset ( $this->_tpl_vars['cell'] )): ?><?php echo $this->_tpl_vars['cell']; ?>
<?php endif; ?>" />
                        </p>
                        <!--
                           <p class="radioType">
