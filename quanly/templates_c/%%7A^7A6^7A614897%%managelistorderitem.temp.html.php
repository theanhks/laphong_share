<?php /* Smarty version 2.6.19, created on 2020-08-08 18:03:26
         compiled from admin/managelistorderitem.temp.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', 'admin/managelistorderitem.temp.html', 100, false),)), $this); ?>
...
<div class="contentabc">
    <?php $this->assign('formId', 'listOrder'); ?>
...
</a> &raquo; <?php echo $this->_tpl_vars['amessages']['list_order_item']; ?>
</h2>
            <ul id="tablist">
                <li class="current"><a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&part=orderitem&act=list" title="<?php echo $this->_tpl_vars['amessages']['list_order_item']; ?>
"><?php echo $this->_tpl_vars['amessages']['list_order_item']; ?>
</a> </li>
                <li><a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&part=orderitem&act=list&plus=cleanTrash" title="<?php echo $this->_tpl_vars['amessages']['clean_trash']; ?>
...
?op=manage&amp;poId=<?php echo $this->_tpl_vars['poId']; ?>
&amp;part=orderitem&amp;act=list&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
...
&amp;part=orderitem&amp;act=list&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
&amp;searchStatus=<?php echo $this->_tpl_vars['searchStatus']; ?>
&amp;orderBy=oid&amp;orderDir=<?php if ($this->_tpl_vars['orderBy'] == 'oid' && $this->_tpl_vars['orderDir'] == 'ASC'): ?>DESC<?php else: ?>ASC<?php endif; ?>" title="<?php echo $this->_tpl_vars['amessages']['click_here_to_sort_by']; ?>
 <?php echo $this->_tpl_vars['amessages']['order']; ?>
"><?php echo $this->_tpl_vars['amessages']['order']; ?>
<?php if ($this->_tpl_vars['orderBy'] == 'oid'): ?>&nbsp;<img src="templates/<?php echo $this->_tpl_vars['usertemplate']; ?>
...
&amp;orderBy=pid&amp;orderDir=<?php if ($this->_tpl_vars['orderBy'] == 'pid' && $this->_tpl_vars['orderDir'] == 'ASC'): ?>DESC<?php else: ?>ASC<?php endif; ?>" title="<?php echo $this->_tpl_vars['amessages']['click_here_to_sort_by']; ?>
 <?php echo $this->_tpl_vars['amessages']['products']; ?>
"><?php echo $this->_tpl_vars['amessages']['products']; ?>
...
/images/ico_<?php if ($this->_tpl_vars['orderDir'] == 'DESC'): ?>down<?php else: ?>up<?php endif; ?>.gif" alt="" width="12" height="12" /><?php endif; ?></a></th>
                            <th><?php echo $this->_tpl_vars['amessages']['quantity']; ?>
</th>
                            <th><?php echo $this->_tpl_vars['amessages']['price']; ?>
</th>
                            <th><a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&amp;oId=<?php echo $this->_tpl_vars['oId']; ?>
&amp;part=orderitem&amp;act=list&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
&amp;searchStatus=<?php echo $this->_tpl_vars['searchStatus']; ?>
...
" /></td>
                            ...
                            <td><?php echo $this->_tpl_vars['order']->getParentName($this->_tpl_vars['object']->getOId()); ?>
</td>
                            <td><?php echo $this->_tpl_vars['products']->getParentName($this->_tpl_vars['object']->getPId(),'vn'); ?>
</td>
                            <td><?php echo $this->_tpl_vars['object']->getSlug(); ?>
</td>
                            <td><?php echo $this->_tpl_vars['object']->getQuantity(); ?>
</td>
                            <td><?php echo $this->_tpl_vars['object']->getPrice(); ?>
</td>
...
<?php endif; ?></td>
                            <td class="first_hd">
                                ...
                                <!--<a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&amp;part=orderitem&amp;act=edit&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
