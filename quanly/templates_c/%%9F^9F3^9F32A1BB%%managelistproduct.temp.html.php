<?php /* Smarty version 2.6.19, created on 2020-08-09 07:29:30
         compiled from admin/managelistproduct.temp.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', 'admin/managelistproduct.temp.html', 113, false),array('modifier', 'truncate', 'admin/managelistproduct.temp.html', 116, false),)), $this); ?>
...
</a> &raquo; <?php echo $this->_tpl_vars['amessages']['list_product']; ?>
</h2>
			<ul id="tablist">
...
" name="searchTerms" />
					...
					<p>
						<span><?php echo $this->_tpl_vars['amessages']['category']; ?>
</span>
...
?op=manage&amp;part=product&amp;act=list&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
...
?op=manage&amp;part=product&amp;act=list&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
&amp;searchStatus=<?php echo $this->_tpl_vars['searchStatus']; ?>
&amp;orderBy=category&amp;orderDir=<?php if ($this->_tpl_vars['orderBy'] == 'category' && $this->_tpl_vars['orderDir'] == 'ASC'): ?>DESC<?php else: ?>ASC<?php endif; ?>" title="<?php echo $this->_tpl_vars['amessages']['click_here_to_sort_by']; ?>
 <?php echo $this->_tpl_vars['amessages']['productcategory']; ?>
"><?php echo $this->_tpl_vars['amessages']['productcategory']; ?>
<?php if ($this->_tpl_vars['orderBy'] == 'category'): ?>&nbsp;<img src="templates/<?php echo $this->_tpl_vars['usertemplate']; ?>
/images/ico_<?php if ($this->_tpl_vars['orderDir'] == 'DESC'): ?>down<?php else: ?>up<?php endif; ?>.gif" alt="" width="12" height="12" /><?php endif; ?></a>
								</th>
								<th>
									<a href="<?php echo $this->_tpl_vars['script']; ?>
...
/images/ico_<?php if ($this->_tpl_vars['orderDir'] == 'DESC'): ?>down<?php else: ?>up<?php endif; ?>.gif" alt="" width="12" height="12" /><?php endif; ?></a>
								...
								<th class="first_at"><?php echo $this->_tpl_vars['amessages']['avatar']; ?>
</th>
								<th class="first_tt">
									<a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&amp;part=product&amp;act=list&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
...
?op=manage&amp;part=product&amp;act=list&amp;pId=<?php echo $this->_tpl_vars['pId']; ?>
...
" /></td>
								...
								<td><?php echo $this->_tpl_vars['pro_cate']->getParentName($this->_tpl_vars['object']->getCategory()); ?>
</td>
								...
								<td class="first_at"><img src="<?php echo $this->_tpl_vars['ROOTPATH']; ?>
/gallery/avatar_upload/products/avatar/<?php echo $this->_tpl_vars['object']->getAvatar(); ?>
" /></td>
...
<?php endif; ?></p></td>
								<!--<td>
								<input type="text" name="position_<?php echo $this->_tpl_vars['object']->getId(); ?>
" id="position_<?php echo $this->_tpl_vars['object']->getId(); ?>
" value="<?php echo $this->_tpl_vars['object']->getPosition(); ?>
" />
								<input type="button" class="btnOK" name="update" value="OK" onClick="javascript:changePosition('<?php echo $this->_tpl_vars['formId']; ?>
','<?php echo $this->_tpl_vars['object']->getId(); ?>
');" />
								</td>-->
								<td class="first_hd">
									<a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&amp;part=product&amp;act=list&amp;oId=<?php echo $this->_tpl_vars['object']->getId(); ?>
&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
&amp;searchStatus=<?php echo $this->_tpl_vars['searchStatus']; ?>
...
">
									...
									<!--<a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&amp;part=product&amp;act=copy&amp;pId=<?php echo $this->_tpl_vars['pId']; ?>
&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
&amp;searchStatus=<?php echo $this->_tpl_vars['object']->getStatus(); ?>
&amp;searchCategory=<?php echo $this->_tpl_vars['object']->getCategory(); ?>
&amp;orderBy=<?php echo $this->_tpl_vars['orderBy']; ?>
&amp;orderDir=<?php echo $this->_tpl_vars['orderDir']; ?>
&amp;oId=<?php echo $this->_tpl_vars['object']->getId(); ?>
&amp;page=<?php echo $this->_tpl_vars['page']; ?>
" title="<?php echo $this->_tpl_vars['amessages']['copy']; ?>
">
										<img src="templates/<?php echo $this->_tpl_vars['usertemplate']; ?>
/images/misc/copy.gif" alt="<?php echo $this->_tpl_vars['amessages']['copy']; ?>
" width="16" height="16" />
									</a>-->
									<a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&amp;part=product&amp;act=edit&amp;oId=<?php echo $this->_tpl_vars['object']->getId(); ?>
&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
&amp;searchStatus=<?php echo $this->_tpl_vars['object']->getStatus(); ?>
&amp;searchCategory=<?php echo $this->_tpl_vars['object']->getCategory(); ?>
&amp;orderBy=<?php echo $this->_tpl_vars['orderBy']; ?>
...
">
									...
									<a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&amp;part=product&amp;act=list&amp;cId=<?php echo $this->_tpl_vars['cId']; ?>
&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
