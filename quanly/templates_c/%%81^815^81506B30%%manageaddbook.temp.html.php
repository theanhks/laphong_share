<?php /* Smarty version 2.6.19, created on 2020-08-13 06:43:53
         compiled from admin/manageaddbook.temp.html */ ?>
 ...
 *</label>
                        ...
                        <p>
                            ...
                            <input type="text" name="name" value="<?php if (isset ( $this->_tpl_vars['name'] )): ?><?php echo $this->_tpl_vars['name']; ?>
<?php endif; ?>" />
                        </p>

                        <p class ="hidden">
                            <label for="en_name">Email</label>
                            <input type="text" name="email" id="email" value="<?php if (isset ( $this->_tpl_vars['email'] )): ?><?php echo $this->_tpl_vars['email']; ?>
<?php endif; ?>"  />
                        </p>

                        <p class ="hidden">
                            <label for="en_name">Số điện thoại</label>
                            <input type="text" name="tel" id="email" value="<?php if (isset ( $this->_tpl_vars['tel'] )): ?><?php echo $this->_tpl_vars['tel']; ?>
<?php endif; ?>"  />
                        </p>

                        <p class ="hidden">
                            <label for="en_name">Ngày đặt</label>
                            <input type="date" name="date" id="date" value="<?php if (isset ( $this->_tpl_vars['date'] )): ?><?php echo $this->_tpl_vars['date']; ?>
<?php endif; ?>"  />
                        </p>

                        <p class ="hidden">
                            <label for="en_name">Giờ đặt</label>
                            <input type="time" name="time" id="time" value="<?php if (isset ( $this->_tpl_vars['time'] )): ?><?php echo $this->_tpl_vars['time']; ?>
<?php endif; ?>"  />
                        </p>

                        <p class ="hidden">
                            <label for="en_name">Ghi chú</label>
                            <input type="text" name="note" id="note" value="<?php if (isset ( $this->_tpl_vars['note'] )): ?><?php echo $this->_tpl_vars['note']; ?>
<?php endif; ?>"  />
                        </p>

                        <p class ="hidden">
                            <label for="en_name">Số lượng</label>
                            <input type="text" name="quantity" id="quantity" value="<?php if (isset ( $this->_tpl_vars['quantity'] )): ?><?php echo $this->_tpl_vars['quantity']; ?>
<?php endif; ?>"  />
                        </p>
