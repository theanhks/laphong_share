<?php /* Smarty version 2.6.19, created on 2020-08-02 10:53:22
         compiled from admin/manageliststaticpage.temp.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', 'admin/manageliststaticpage.temp.html', 100, false),array('modifier', 'truncate', 'admin/manageliststaticpage.temp.html', 104, false),)), $this); ?>
...
</a> &raquo; <?php echo $this->_tpl_vars['amessages']['list_static_page']; ?>
</h2>
			<ul id="tablist">
				<li class="hidden"><a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&amp;part=staticPage&amp;act=add&amp;cId=<?php if (isset ( $this->_tpl_vars['cId'] )): ?><?php echo $this->_tpl_vars['cId']; ?>
<?php endif; ?>" title="<?php echo $this->_tpl_vars['amessages']['add_entry']; ?>
"><?php echo $this->_tpl_vars['amessages']['add_static_page']; ?>
</a> </li>
				<li class="current"><a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&part=staticPage&act=list" title="<?php echo $this->_tpl_vars['amessages']['list_entry']; ?>
...
?op=manage&amp;part=staticPage&amp;act=list&amp;cId=<?php echo $this->_tpl_vars['cId']; ?>
...
&amp;searchLang=<?php echo $this->_tpl_vars['searchLang']; ?>
&amp;searchStatus=<?php echo $this->_tpl_vars['searchStatus']; ?>
&amp;orderBy=slug&amp;orderDir=<?php if ($this->_tpl_vars['orderBy'] == 'id' && $this->_tpl_vars['orderDir'] == 'ASC'): ?>DESC<?php else: ?>ASC<?php endif; ?>" title="<?php echo $this->_tpl_vars['amessages']['click_here_to_sort_by']; ?>
...
" /></td>
								...
								<!--<td><?php echo $this->_tpl_vars['object']->getLang(); ?>
</td>-->
								<td><a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&part=staticPage&act=list&pId=<?php echo $this->_tpl_vars['object']->getId(); ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['object']->getName('vn'))) ? $this->_run_mod_handler('truncate', true, $_tmp, 50) : smarty_modifier_truncate($_tmp, 50)); ?>
</a></td>
...
" width="16" height="16" /></a>-->
									<a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&amp;part=staticPage&amp;act=edit&amp;pId=<?php echo $this->_tpl_vars['object']->getProperties(); ?>
...
&amp;page=<?php echo $this->_tpl_vars['page']; ?>
" title="Xóa khỏi mục xuất khẩu"><img src="templates/<?php echo $this->_tpl_vars['usertemplate']; ?>
...
&amp;page=<?php echo $this->_tpl_vars['page']; ?>
" title="Đưa vào mục xuất khẩu"><img src="templates/<?php echo $this->_tpl_vars['usertemplate']; ?>
