<?php /* Smarty version 2.6.19, created on 2020-08-02 03:16:13
         compiled from admin/managelistcategory.temp.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', 'admin/managelistcategory.temp.html', 100, false),)), $this); ?>
...
</a> &raquo; <?php echo $this->_tpl_vars['amessages']['list_category']; ?>
</h2>
			<ul id="tablist">
...
"><?php echo $this->_tpl_vars['amessages']['add_category']; ?>
</a> </li>
...
?op=manage&amp;part=category&amp;act=list&amp;pId=<?php echo $this->_tpl_vars['pId']; ?>
...
/images/ico_<?php if ($this->_tpl_vars['orderDir'] == 'DESC'): ?>down<?php else: ?>up<?php endif; ?>.gif" alt="" width="12" height="12" /><?php endif; ?></a></th>
								<th><?php echo $this->_tpl_vars['amessages']['parent']; ?>
</th>
								<!--<th><a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&amp;part=category&amp;act=list&amp;pId=<?php echo $this->_tpl_vars['pId']; ?>
&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
&amp;searchStatus=<?php echo $this->_tpl_vars['searchStatus']; ?>
&amp;orderBy=slug&amp;orderDir=<?php if ($this->_tpl_vars['orderBy'] == 'slug' && $this->_tpl_vars['orderDir'] == 'ASC'): ?>DESC<?php else: ?>ASC<?php endif; ?>" title="<?php echo $this->_tpl_vars['amessages']['click_here_to_sort_by']; ?>
 <?php echo $this->_tpl_vars['amessages']['slug']; ?>
"><?php echo $this->_tpl_vars['amessages']['slug']; ?>
<?php if ($this->_tpl_vars['orderBy'] == 'slug'): ?>&nbsp;<img src="templates/<?php echo $this->_tpl_vars['usertemplate']; ?>
/images/ico_<?php if ($this->_tpl_vars['orderDir'] == 'DESC'): ?>down<?php else: ?>up<?php endif; ?>.gif" alt="" width="12" height="12" /><?php endif; ?></a></th>-->
								<th><a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&amp;part=category&amp;act=list&amp;pId=<?php echo $this->_tpl_vars['pId']; ?>
&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
...
&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
&amp;searchStatus=<?php echo $this->_tpl_vars['searchStatus']; ?>
&amp;orderBy=avatar&amp;orderDir=<?php if ($this->_tpl_vars['orderBy'] == 'avatar' && $this->_tpl_vars['orderDir'] == 'ASC'): ?>DESC<?php else: ?>ASC<?php endif; ?>" title="<?php echo $this->_tpl_vars['amessages']['click_here_to_sort_by']; ?>
 <?php echo $this->_tpl_vars['amessages']['avatar']; ?>
"><?php echo $this->_tpl_vars['amessages']['avatar']; ?>
<?php if ($this->_tpl_vars['orderBy'] == 'avatar'): ?>&nbsp;<img src="templates/<?php echo $this->_tpl_vars['usertemplate']; ?>
/images/ico_<?php if ($this->_tpl_vars['orderDir'] == 'DESC'): ?>down<?php else: ?>up<?php endif; ?>.gif" alt="" width="12" height="12" /><?php endif; ?></a></th>-->
								<th class="first_tt"><a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&amp;part=category&amp;act=list&amp;pId=<?php echo $this->_tpl_vars['pId']; ?>
&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
&amp;searchStatus=<?php echo $this->_tpl_vars['searchStatus']; ?>
...
/images/ico_<?php if ($this->_tpl_vars['orderDir'] == 'DESC'): ?>down<?php else: ?>up<?php endif; ?>.gif" alt="" width="12" height="12" /><?php endif; ?></a></th>
								<th class="first_vt"><a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&amp;part=category&amp;act=list&amp;pId=<?php echo $this->_tpl_vars['pId']; ?>
&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
&amp;searchStatus=<?php echo $this->_tpl_vars['searchStatus']; ?>
...
" /></td>
								...
								<td><?php echo $this->_tpl_vars['categories']->getParentName($this->_tpl_vars['object']->getPId()); ?>
</td>
								<!--<td><?php echo $this->_tpl_vars['object']->getSlug(); ?>
</td>-->
								<td><a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&part=category&act=list&pId=<?php echo $this->_tpl_vars['object']->getId(); ?>
"><?php echo $this->_tpl_vars['object']->getName('vn'); ?>
</a>&nbsp;&nbsp;<?php if ($this->_tpl_vars['object']->getProperties() == 1): ?><img src="templates/<?php echo $this->_tpl_vars['usertemplate']; ?>
/images/misc/hot.gif" alt="<?php echo $this->_tpl_vars['amessages']['down']; ?>
" /><?php endif; ?></td>
								<!--<td><a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&part=category&act=list&pId=<?php echo $this->_tpl_vars['object']->getId(); ?>
"><?php echo $this->_tpl_vars['object']->getName('en'); ?>
</a></td>-->
								<!--<td><?php if ($this->_tpl_vars['object']->getAvatar()): ?><img src="<?php echo $this->_tpl_vars['ROOTPATH']; ?>
/gallery/avatar_upload/category/avatar/<?php echo $this->_tpl_vars['object']->getAvatar(); ?>
" width="75" height="75" border="0" /><?php else: ?><img src="templates/<?php echo $this->_tpl_vars['usertemplate']; ?>
/images/ico_down.gif" alt="<?php echo $this->_tpl_vars['amessages']['down']; ?>
" width="16" height="16" /><?php endif; ?></td>-->
...
">
									...
									<a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&amp;part=category&amp;act=edit&amp;pId=<?php echo $this->_tpl_vars['object']->getPId(); ?>
&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
