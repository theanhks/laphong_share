<?php /* Smarty version 2.6.19, created on 2020-08-07 18:55:28
         compiled from admin/manageaddproductcategory.temp.html */ ?>
...
</a> &raquo; <?php echo $this->_tpl_vars['amessages']['add_productcategory']; ?>
</h2>
			<ul id="tablist">
 ...
 *</label>
						...
						<!--<p>
							<label for="slug"><?php echo $this->_tpl_vars['amessages']['slug']; ?>
 *</label>
							<span><?php echo $this->_tpl_vars['amessages']['slug_help']; ?>
</span>
							<input type="text" name="slug" value="<?php echo $this->_tpl_vars['slug']; ?>
" />
						</p>-->
						<p>
...
" />
						...
						<p style="display:none">
							<label for="en_name"><?php echo $this->_tpl_vars['amessages']['en_details']; ?>
</label>
							<span><?php echo $this->_tpl_vars['amessages']['en_details_help']; ?>
</span>
							<textarea name="en_details" cols="10" rows="10" class="mceSimple"><?php echo $this->_tpl_vars['en_details']; ?>
</textarea>
						</p>
						<p>
 ...
 tiếng anh</label>
						...
						<p>
							<label for="en_name"><?php echo $this->_tpl_vars['amessages']['position']; ?>
 </label>
