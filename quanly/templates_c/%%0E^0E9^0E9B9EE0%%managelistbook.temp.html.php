<?php /* Smarty version 2.6.19, created on 2020-08-13 09:11:27
         compiled from admin/managelistbook.temp.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', 'admin/managelistbook.temp.html', 106, false),)), $this); ?>
...
<div class="contentabc">
    <?php $this->assign('formId', 'listBook'); ?>
...
</a> &raquo; <?php echo $this->_tpl_vars['amessages']['list_book']; ?>
</h2>
            <ul id="tablist">
...
?op=manage&part=book&act=list" title="<?php echo $this->_tpl_vars['amessages']['list_order']; ?>
...
?op=manage&amp;part=book&amp;act=list&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
&amp;searchStatus=<?php echo $this->_tpl_vars['searchStatus']; ?>
&amp;orderBy=name&amp;orderDir=<?php if ($this->_tpl_vars['orderBy'] == 'name' && $this->_tpl_vars['orderDir'] == 'ASC'): ?>DESC<?php else: ?>ASC<?php endif; ?>" title="<?php echo $this->_tpl_vars['amessages']['click_here_to_sort_by']; ?>
 <?php echo $this->_tpl_vars['amessages']['name']; ?>
">Tên khách hàng<?php if ($this->_tpl_vars['orderBy'] == 'name'): ?>&nbsp;<img src="templates/<?php echo $this->_tpl_vars['usertemplate']; ?>
...
?op=manage&amp;part=book&amp;act=list&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
&amp;searchStatus=<?php echo $this->_tpl_vars['searchStatus']; ?>
&amp;orderBy=email&amp;orderDir=<?php if ($this->_tpl_vars['orderBy'] == 'email' && $this->_tpl_vars['orderDir'] == 'ASC'): ?>DESC<?php else: ?>ASC<?php endif; ?>" title="<?php echo $this->_tpl_vars['amessages']['click_here_to_sort_by']; ?>
 <?php echo $this->_tpl_vars['amessages']['email']; ?>
"><?php echo $this->_tpl_vars['amessages']['email']; ?>
<?php if ($this->_tpl_vars['orderBy'] == 'email'): ?>&nbsp;<img src="templates/<?php echo $this->_tpl_vars['usertemplate']; ?>
/images/ico_<?php if ($this->_tpl_vars['orderDir'] == 'DESC'): ?>down<?php else: ?>up<?php endif; ?>.gif" alt="" width="12" height="12" /><?php endif; ?></a>
                            </th>
...
?op=manage&amp;part=book&amp;act=list&amp;searchTerms=<?php echo $this->_tpl_vars['searchTerms']; ?>
&amp;searchStatus=<?php echo $this->_tpl_vars['searchStatus']; ?>
&amp;orderBy=date&amp;orderDir=<?php if ($this->_tpl_vars['orderBy'] == 'date' && $this->_tpl_vars['orderDir'] == 'ASC'): ?>DESC<?php else: ?>ASC<?php endif; ?>" title="<?php echo $this->_tpl_vars['amessages']['click_here_to_sort_by']; ?>
 <?php echo $this->_tpl_vars['amessages']['book_date']; ?>
">Ngày đặt<?php if ($this->_tpl_vars['orderBy'] == 'date'): ?>&nbsp;<img src="templates/<?php echo $this->_tpl_vars['usertemplate']; ?>
/images/ico_<?php if ($this->_tpl_vars['orderDir'] == 'DESC'): ?>down<?php else: ?>up<?php endif; ?>.gif" alt="" width="12" height="12" /><?php endif; ?></a>
                            </th>
                            <th>Giờ đặt</th>
                            <th>Số lượng</th>
...
" /></td>
                        ...
                        <td><?php echo $this->_tpl_vars['object']->getName(); ?>
</td>
                        <td><?php echo $this->_tpl_vars['object']->getEmail(); ?>
</td>
                        <td><?php echo $this->_tpl_vars['object']->getTel(); ?>
</td>
                        <td><?php echo $this->_tpl_vars['object']->getDate(); ?>
</td>
                        <td><?php echo $this->_tpl_vars['object']->getTime(); ?>
</td>
                        <td><?php echo $this->_tpl_vars['object']->getQuantity(); ?>
</td>
                        <td><?php echo $this->_tpl_vars['object']->getNote(); ?>
</td>
                        <td><p><?php if ($this->_tpl_vars['object']->isDeleted()): ?><span style="color: #FF0000"><?php echo $this->_tpl_vars['object']->getStatusText(); ?>
</span><?php else: ?><?php echo $this->_tpl_vars['object']->getStatusText(); ?>
<?php endif; ?></p></td>
                        <td  class="first_hd">
                            <a href="<?php echo $this->_tpl_vars['script']; ?>
?op=manage&part=book&act=edit&id=<?php echo $this->_tpl_vars['object']->getId(); ?>
