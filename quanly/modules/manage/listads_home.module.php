...
$adsItems = $ads->getObjects($page, $searchCond, /*array($orderBy => $orderDir)*/array('id' => 'ASC'), $items_per_pages);
//var_dump($adsItems);
$template->assign("listObjects",$adsItems);

# Generate and pass link pager to template
$listPage = linkPager(ADMIN_SCRIPT."?op=manage&amp;part=ads_home&amp;act=list&amp;searchTerms=".$searchTerms."&amp;status=".$searchStatus."&amp;searchGroupAds=".$searchGroupAds."&amp;orderBy=".$orderBy."&amp;orderDir=".$orderDir."&amp;page=%s",$pages,$page);
