...
$galleryItems = $gallery->getObjects($page, $searchCond, array($orderBy => $orderDir), $items_per_pages);
$template->assign("listObjects",$galleryItems);

# Generate and pass link pager to template
$listPage = linkPager(ADMIN_SCRIPT."?op=manage&amp;part=gallery&amp;act=list&amp;searchTerms=".$searchTerms."&amp;status=".$searchStatus,$pages,$page);
