...
$templateFile = "manageeditcustomer.temp.html";
...
$customerItem = $customers->getObject($oId);
$template->assign("listObject",$customerItem);
if($oId && $customerItem){
	if($_POST) {
		...
		$fields = array('nhomid'=>$customer->getNhom(),
			...
			$customers->updateData($fields,$oId);
