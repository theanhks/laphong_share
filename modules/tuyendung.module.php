...
$tuyendung_per_page = $siteConfigs->getProperty('tuyendung_per_page');
#end tin tuc left
...
$entries      = new Entries();
$templateFile = "tuyendung.tpl.html";
$id           = $request->element('id', '');
$template->assign("id", $id);
$page = $request->element('page', 1);
$template->assign("page", $page);
$entries      = new Entries();
$tuyendungSub = $entries->getObjects($page,"cid=42",array('id'=>'DESC'),$tuyendung_per_page);
$pages = $entries->getNumItems('id',"cid=42",$tuyendung_per_page);
$rows = $pages['rows'];
$pages = $pages['pages'];

$listPage = linkPager1_dimoda(ROOTPATH."/$lang/tuyen-dung/page-%s.html",$pages,$page);
if($page > $pages) $page = $pages;
$template->assign("pager",$listPage);
$template->assign("pages",$pages);
$template->assign("rows",$rows);
$template->assign('tuyendungSub',$tuyendungSub);
